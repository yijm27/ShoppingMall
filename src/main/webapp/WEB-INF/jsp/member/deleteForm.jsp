...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
			<div class="container">
				<a class="navbar-brand" href="${pageContext.request.contextPath}/home/main.do">M3.com(deleteForm)</a>
			    ...
			    <div class="form-wrap">
			      <div class="col-lg-12 text-center">
					...
					<div >
						<form method="post">
							<div>
								<ul><input id="mname" type="text" name="mname" class="input-field" disabled value="${member.mname}"/></ul>
							</div>
							<div>
								<input id="mid" type="text" name="mid" class="input-field" disabled placeholder="${member.mid}"/>
							</div>
							<div>
								<ul><input id="mpass1" type="password" name="mpassword" class="input-field" readonly value="${member.mpassword}"/></ul>
								
							</div>
							<div>
								<ul><input id="mpass2" type="password" class="input-field" value="${member.mpassword}"/></ul>
							</div>
							
							<div>
								
								<ul><input id="mbirth1" type="text" name="mbirth" size="10" maxlength="6" class="input-field" readonly value="${member.mbirth}" />
							</div>
							<div>
								
								<ul><input id="mtel" type="tel" name="mtel" maxlength="20" class="input-field" readonly value="${member.mtel}"/></ul>
							</div>
							<div>
								<ul><input id="memail" type="email" name="memail" maxlength="20" class="input-field" readonlt value="${member.memail}"/>
							</div>
							<div>
								<ul><input type="address" name="maddress" class="input-field" readonly value="${member.maddress}"/></ul>
							</div>
							...
							<div class="button-wrap">
								<input class="togglebtn" type="submit" value="회원 정보 삭제"/>
